...
const moodStorage = jest.requireMock('../storage/moodStorage') as { getAllEntries: jest.Mock };
const goalsStorage = jest.requireMock('../storage/goalsStorage') as { getGoals: jest.Mock };
const habitStorage = jest.requireMock('../storage/habitSelectionsStorage') as {
  getHabitSelectionsRecordSnapshot: jest.Mock;
};
const tasksStorage = jest.requireMock('../storage/tasksStorage') as { getTaskDayIndexSnapshot: jest.Mock };
