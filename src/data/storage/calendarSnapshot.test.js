...
import { fetchMoodCalendarSnapshot, invalidateMoodCalendarSnapshotWarmCacheForTests, peekMoodCalendarSnapshotFromWarmCache, } from './calendarSnapshot';
const { getCalendarEntriesByMonthIndexSnapshot, getEntriesSessionEpoch } = require('./moodStorage');
const { getSettings, getSettingsSessionEpoch } = require('./settingsStorage');
const baseSettings = {
    appearance: 'system',
