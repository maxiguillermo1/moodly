...
const PERF_SCREEN_TO_MAIN_TAB = {
    Today: 'Today',
    Journal: 'Journal',
    CalendarScreen: 'Calendar',
    CalendarView: 'Calendar',
};
export function usePerfScreen(screenName, opts) {
    ...
    const transitionStartMsRef = useRef(null);
