...
export function useCalendarEntryEdit({ initialSelectedDate, mountedRef, entriesRevisionRef, setEntriesByMonthKey, reduceMotion, onEntriesMutated, }) {
    ...
    const handleSave = useCallback(async () => {
        ...
        if (perfProbe.enabled)
            perfProbe.setCulpritPhase('CalendarScreen.modalSave');
