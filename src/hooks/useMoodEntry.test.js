...
jest.mock('../storage/entries', () => ({
    ...
    peekEntryFromSessionCache: (...a) => mockPeekEntry(...a),
    upsertEntry: (...a) => mockUpsertEntry(...a),
    createEntry: (...a) => mockCreateEntry(...a),
}));
jest.mock('../security', () => ({
...
describe('useMoodEntry', () => {
    ...
    beforeEach(() => {
        ...
        mockCreateEntry.mockImplementation((date, mood, note) => ({
            date,
            mood,
            note,
            createdAt: 1,
