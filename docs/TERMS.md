...
Features and these terms may change between releases. Continued use after an update constitutes acceptance of the updated terms where permitted by law.

## Contact

See **Support** in Settings or the project repository issue tracker.

**Note for maintainers:** Publish at a stable HTTPS URL for store listings if required.
